...
# Date: 08 Mar 2011
#
# This module defines the Script class that creates a script from an SODE
# class. The idea is to be able to define an SODE script class and then
# quickly use the definition to produce numerical solutions.
